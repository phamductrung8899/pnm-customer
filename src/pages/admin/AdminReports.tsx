    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 py-6 space-y-6">
      ...
      <Card>
        <CardContent className="flex items-center gap-4 p-4">
          ...
          <Badge variant="outline" className="ml-auto">{selectedCustomer.name}</Badge>
        </CardContent>
      </Card>
      ...
      <Tabs defaultValue="traffic" className="space-y-4">
        ...
        <TabsContent value="traffic" className="space-y-4">
          ...
          <Card>
            <CardHeader><CardTitle className="text-base">Chi tiết lưu lượng theo đầu số</CardTitle></CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                  <TableRow>
        ...
        <TabsContent value="revenue" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader><CardTitle className="text-base">Tổng doanh thu tháng hiện tại</CardTitle></CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader><CardTitle className="text-base">Phân bổ doanh thu</CardTitle></CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={240}>
                  <PieChart>
                    <Pie data={mockRevenueComponents} cx="50%" cy="50%" outerRadius={90} dataKey="amount" nameKey="name"
                      label={({ name, percent }) => `${name} ${(percent * 100).toFixed(0)}%`} labelLine={false}>
                      {mockRevenueComponents.map((entry, i) => <Cell key={i} fill={entry.color} />)}
                    </Pie>
          ...
          <Card>
            <CardHeader><CardTitle className="text-base">Chi tiết cước theo đầu số</CardTitle></CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                  <TableRow>
